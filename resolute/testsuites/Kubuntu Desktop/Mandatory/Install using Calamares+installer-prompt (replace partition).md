...
At the ""Partions"" pane, select the ""Replace a partition"" radio button
   At the top, the correct storage device should be selected
   Below the radio button, ""ext4"" is selected from a drop down and ""xfs"" and ""btrfs"" are the other options
   Above the partition layout, ""Encrypt system"" should be unchecked
   At the bottom, a partition layout should be shown
   Below the partition layout, the bootloader should show that it's being installed to the correct location
Select the target partition from the ""Current"" bar and click ""Next""
   The ""After"" bar should show the target partition being replaced
