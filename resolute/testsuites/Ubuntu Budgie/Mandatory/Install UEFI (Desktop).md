The scope of this test is to ensure that the image boots in UEFI and that the resulting installation can boot in UEFI as well, regardless of network availability. _Proceed in your native language if you wish. Instructions will remain in English_

Unplug network cable
    No networking should be available to the system
Boot up the image in UEFI mode
