Scope of this test is to verify that the system is installed, you can login and run VMs. *Proceed in your native language if you wish. Instructions will remain in English*
