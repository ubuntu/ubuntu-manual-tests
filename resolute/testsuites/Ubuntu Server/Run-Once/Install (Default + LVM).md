Scope of this test is to verify that the system is installed, you can login into it and rootfs is rightly mounted. _Proceed in your native language if you wish. Instructions will remain in English_
...
At partitioning select ""Guided - Use entire disk and set up LVM""
...
Login and run:
    sudo mount
    Verify that the root file system is mounted from /dev/mapper/ubuntu-root.
