This test case is to be carried out on a Raspberry Pi Compute Module 4 2GB.
...
Launch Settings from the menu that appears, then ""About"" in the left panel of the window that appears 
     Reported ""Memory"" is consistent with a Raspberry Pi Compute Module 4 2GB. It should be in the region of 1.6-1.8GB. 
