This test case is to be carried out on a Raspberry Pi 5 16GB.
...
Launch Settings from the menu that appears, then ""About"" in the left panel of the window that appears 
     Reported ""Memory"" is consistent with a Raspberry Pi 5 16GB. It should be in the region of 15GB. 
