...
Follow the installation steps at IoT installation media, and write the image to the internal eMMC. Then, using sudo rpi-eeprom-config, ensure the EEPROM's BOOT\_ORDER is set to 0xf1.
