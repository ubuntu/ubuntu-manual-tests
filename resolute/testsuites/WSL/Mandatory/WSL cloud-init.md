...
It's possible that it fails due [this WSL bug](<>). To confirm that try again with a different XDG_RUNTIME_DIR as below: 
...
Check that Windows interoperability is still working      Launch a Windows application 
