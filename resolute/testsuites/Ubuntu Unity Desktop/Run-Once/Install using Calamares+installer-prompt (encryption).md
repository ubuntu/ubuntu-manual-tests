...
At the ""Partions"" pane, select the ""Erase disk"" radio button
...
Enter two matching passphrases in the prompts and click ""Next""
   ...
   The ""After"" partition layout at the bottom should show the target partition for the installation as LUKS2
