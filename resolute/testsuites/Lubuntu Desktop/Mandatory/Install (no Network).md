_Please ensure that your system has no Internet access before proceeding. Proceed in your native language if you wish. Instructions will remain in English._
...
On the screen 'Updates and other software', note the availability of the following components
  ...
  * (If network is available (_Should be disabled_)) Download updates while installing FAMILY
...
Select Erase disk and install FAMILY
...
With the system not connected to the network, a US timezone is preselected. Set the timezone to match your local time.
    Timezone and city displayed now match what you have just set it to.
...
Allow the machine to reboot
    The system boots properly and loads into FAMILY showing username selected at step 13
