*Proceed in your native language if you wish. Instructions will remain in English* This test will check installation of xubuntu minimal with tasksel
...
*The install may seem like it has locked at a percentage but is actually working in the background. You can check and see if it is working by switching to tty4*
Select to not install updates. The base installation finishes
