...
Boot up the image
   The system boots properly and loads to the live session desktop
Click on the Install FAMILY Core icon
   The 'Keyboard Layout' screen appears
   The proposed keyboard corresponds with your keyboard
Select your keyboard layout and click on continue
   The Preparing to install FAMILY dialogue shows
...
If there is only one hard disk, skips to the 'Where are you?' screen. Otherwise, on the 'Installation type' screen verify that the drive selected on the Select drive list corresponds to the drive on the chart (e.g /dev/sda)
...
Allow the machine to reboot
   The system boots properly and loads into FAMILY showing username during installation
Enter password for user and login
   Desktop shows
