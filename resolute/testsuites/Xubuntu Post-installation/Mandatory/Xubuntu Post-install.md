If options are available, these tests are to be undertaken *following* a successful install of Xubuntu. Network connections
...
*Lock and suspend testing* *If unlocking requires more than one password entry - fail the testcase* **To test desktop locking, a new user should be created with the User and Groups option from Settings menu** **Testing on Hardware** Test Suspend
