...
When installer-prompt starts select a non-English language in the first prompt
...
Press ""Install FAMILY"" and wait for Calamares installer to start
    Calamares starts and all of its strings are shown in the selected language
...
In the ""Keyboard"" pane, select your keyboard layout and click ""Next""
    The default keyboard layout shown should be appropriate for the language selected
...
Allow the machine to reboot
    The system boots properly and loads into FAMILY showing the username you entered and using the selected language
