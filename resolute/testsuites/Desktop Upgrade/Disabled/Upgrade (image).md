To execute this test, a pre-existing ubuntu (or derivative) installation **of an older major version** is needed **Upgrade will only be offered as an alternative when there is 1 installed FAMILY system** *Proceed in your native language if you wish. Instructions will remain in English*
