To execute this test, a pre-existing Ubuntu (or derivative) installation is needed **Upgrade will only be offered as an alternative when there is 1 installed FAMILY system** _Proceed in your native language if you wish. Instructions will remain in English._
