The scope of this test is to ensure that the image boots in UEFI, that the resulting installation can boot in UEFI as well, regardless of network availability and that nVidia proprietary drivers are installed and loaded. _Proceed in your native language if you wish. Instructions will remain in English_
