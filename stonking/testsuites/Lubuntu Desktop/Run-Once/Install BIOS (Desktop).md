The scope of this test is to ensure that the image boots in BIOS and that the resulting installation can boot in BIOS as well, regardless of network availability.
...
<dl>
    ...
    <dt>Allow the machine to reboot</dt>
        <dd>The system boots properly and loads into FAMILY showing username selected at step 14</dd>
</dl>
