...
<dl>
    <dt>Boot up the image</dt>
        <dd>System boots to 'Select a language'</dd>
    <dt>Select Install FAMILY and press Enter</dt>
        <dd>System displays 'Select your location'</dd>
    ...
    <dt>Select the layout you wish to use on the keyboard and press Enter</dt>
        <dd>The default for your location and language should already be selected. You should be informed that no network interfaces were found.</dd>
    <dt>Select Continue and press Enter</dt>
        <dd>You should be prompted for system hostname</dd>
    ...
    <dt>Select Yes to accept the changes and press Enter</dt>
        <dd>Base system installs</dd>
        <dd>You should see a request for http proxy information</dd>
    <dt>Press Enter to leave proxy configuration empty</dt>
    ...
    <dt>Select Yes to set your clock to UTC and press Enter</dt>
