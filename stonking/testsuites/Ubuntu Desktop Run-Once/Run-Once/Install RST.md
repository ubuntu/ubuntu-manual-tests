...
<dt>In GRUB boot menu, select UEFI Firmware settings</dt>
<dt>Check hardware settings for the hard-drive and if set to ACPI mode, change it to "RAID" or "RST"</dt>
<dt>Save and exit the firmware</dt>
