...
<dl>
    ...
    <dt>When the installer starts and displays a Welcome dialog select your language in the left column</dt>
    ...
    <dt>On the screen Preparing to install FAMILY, note the availability of the following components</dt>
        ...
        <dd>
            <ul>
                <li>Download updates while installing FAMILY should be unavailable</li>
