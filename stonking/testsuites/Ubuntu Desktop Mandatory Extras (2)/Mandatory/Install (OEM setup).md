...
<dl>
    ...
    <dt>Execute the following command on the command line to install any updates that may be present <code>sudo apt-get update && sudo apt-get dist-upgrade</code></dt>
    ...
    <dt>Execute the following command on the command line: <code>lsb_release -rd</code></dt>
        <dd>Both the description and the release presented matches the version of FAMILY you installed</dd>
    <dt>Execute the following command on the command line: <code>arch</code></dt>
    ...
    <dt>Execute the following command on the command line: <code>sudo sfdisk -l</code></dt>
        <dd>Verify the partition scheme displayed matches the partition scheme you chose during installation</dd>
    <dt>Execute the following command on the command line: <code>sudo apt-get update</code></dt>
