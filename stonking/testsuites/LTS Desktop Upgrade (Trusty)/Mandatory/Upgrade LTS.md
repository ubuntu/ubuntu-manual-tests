...
<dl>
    ...
    <dt>Ensure the upgrade process is looking for any new LTS version by running 'Software & Updates' or clicking "Settings ..." in update-manager. Select the updates tab, and make sure the 'Notify me of a new Ubuntu version' option has the 'For long-term support versions' value selected</dt>
