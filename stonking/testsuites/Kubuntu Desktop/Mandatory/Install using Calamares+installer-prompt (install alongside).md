# Kubuntu: Install using Calamares + installer-prompt (install alongside)
...
- Allow the machine to reboot
  ...
  - After sitting for a few seconds, the system automatically continues boot and loads into Kubuntu showing the username you entered
