# Lubuntu: Install using Calamares + installer-prompt (non-English)
...
- Allow the machine to reboot
  - The system boots properly and loads into Lubuntu showing the username you entered and using the selected language
