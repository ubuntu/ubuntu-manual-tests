...
<dl>
    ...
    <dt>Ensure Kubuntu is looking from all new versions by running 'Software & Updates'. Select the updates tab, and make sure the 'Notify me of a new Kubuntu version' option has the 'For any new version' selection</dt>
