The scope of this test is to ensure that the image boots in UEFI and that the resulting installation can boot in UEFI as well, regardless of network availability.
