...
Select Try FAMILY without any change to your computer and press Enter
   -   Once the live session has started, verify that the system is localized to the previously selected language
