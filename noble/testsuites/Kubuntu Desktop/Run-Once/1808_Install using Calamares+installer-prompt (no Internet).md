...
When installer-prompt starts select your language in the first prompt
    ...
    Internet connection is shown as ""Disconnected"" in the second prompt
...
At the ""Customize"" pane, click ""Next""
    ""Normal Installation"" should be selected, but there is also a option for ""Minimal Installation""
