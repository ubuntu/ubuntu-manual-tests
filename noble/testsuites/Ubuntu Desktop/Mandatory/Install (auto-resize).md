...
**If the target drive has a free partition with sufficient free space, install will proceed without further partitioning intervention**     The drive corresponds to the drive on the chart (e.g /dev/sda) and the bar is divided
Move the bar that separates the sections as appropriate
