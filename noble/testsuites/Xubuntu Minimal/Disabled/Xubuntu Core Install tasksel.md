_Proceed in your native language if you wish. Instructions will remain in English_ This test will check installation of xubuntu minimal with tasksel 

Boot the image
Select Install and press Enter
    Select Language screen displays
...
Add a hostname for the machine and press Enter
    Choose a mirror dialogue displays
Select an Ubuntu mirror
    HTTP Proxy screen displays
Either enter proxy information and continue, or continue leaving blank
    Install continues
...
_The install may seem like it has locked at a percentage but is actually working in the background. You can check and see if it is working by switching to tty4_ Select to not install updates. The base installation finishes
    The Software selection screen appears
Select Xubuntu minimal installation with the space bar and press enter 
