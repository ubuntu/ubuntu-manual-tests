Scope of this test is to verify that the system is installed, you can login into it, Apache and MySQL are working. _Proceed in your native language if you wish. Instructions will remain in English_
