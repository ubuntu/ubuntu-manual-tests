This test will check that the Ubuntu Server system is installed and you can login into it _Proceed in your native language if you wish. Instructions will remain in English_
