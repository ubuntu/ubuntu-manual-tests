...
Open the main page to the MAAS server
Find the option in the MAAS server preferences to periodically update cloud images.
...
Open the main page to the MAAS server
Find the option in the MAAS server preferences to cache archives locally
Enable the option
