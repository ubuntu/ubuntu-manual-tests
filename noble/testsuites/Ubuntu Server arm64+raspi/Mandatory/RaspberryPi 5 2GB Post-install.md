This test case is to be carried out on a Raspberry Pi 5 2GB.
...
Check output of `free -h`
   Reported ""Mem"" under ""total"" is consistent with a Raspberry Pi 5 2GB. It should be in the region of 1.6-1.8GB.
