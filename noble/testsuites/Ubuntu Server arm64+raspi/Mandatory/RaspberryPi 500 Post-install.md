...
With an HDMI monitor that supports audio plugged into the HDMI0 output, and an available MP3 file: 
  ...
  * Attempt to play your MP3 file with: `ffmpeg -i _music.mp3_ -f alsa default:CARD=_name_` substituting _name_ for the card name found during the previous step, and _music.mp3_ for your choice of MP3 file, e.g. `ffmpeg ""Jeff Wayne - War of the Worlds.mp3"" -f alsa default:CARD=vc4hdmi0`
