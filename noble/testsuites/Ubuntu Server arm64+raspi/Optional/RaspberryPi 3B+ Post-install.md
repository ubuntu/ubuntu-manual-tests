...
Check output of `free -h`
   Reported ""Mem"" under ""total"" is consistent with a Raspberry Pi 3B+. It should be in the region of 800-1000MB.
...
-   Kill the stress process
   The output should be around 1.4GHz (obtained from online specs)
