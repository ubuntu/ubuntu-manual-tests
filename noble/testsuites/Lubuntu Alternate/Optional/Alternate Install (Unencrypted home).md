...
Boot up the image
    System boots to Installer language 'Select Language'
Select Install FAMILY and press Enter
    Language selection windows opens
Select language for installed system
...
Select 'Yes' to unmount partitions that are in use
...
Select Yes to install grub boot loader to master boot record and a dialog box for your partition information will come up and you can choose target drive from there manually, for example /dev/sda or /dev/sdb.
