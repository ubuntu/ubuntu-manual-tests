...
Boot up the image
    System boots to 'Select a language'
Select Install FAMILY and press Enter
    System displays 'Select your location'
...
Select the layout you wish to use on the keyboard and press Enter
    The default for your location and language should already be selected. You should be informed that no network interfaces were found.
Select Continue and press Enter
    You should be prompted for system hostname
...
Press Enter to leave proxy configuration empty
...
Select Yes to set your clock to UTC and press Enter
