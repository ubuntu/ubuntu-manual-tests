...
In GRUB boot menu, select UEFI Firmware settings
Check hardware settings for the hard-drive and if set to ACPI mode, change it to ""RAID"" or ""RST""
Save and exit the firmware
Boot up the image
