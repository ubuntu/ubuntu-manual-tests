Several icons exist in indicator(at the right bottom of the screen)
...
Click “Network settings” icon in indicator
   Several options show up, such as Ethernet Network/disconnected/VPN Connections/ Enable Networking/ Connection Information/ Edit Connections. Click the options and set network successfully.
